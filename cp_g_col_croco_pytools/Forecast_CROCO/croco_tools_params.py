...
#
RUN_dir = os.getenv('CROCO_RUN_DIR', '/data/18-06-2026/')
#
...
#
# GFS forecast atmospheric output switches (1 = process)
# used by make_gfs.py
makeblk_gfs = 1        # create bulk atmospheric forcing file (croco_blk_GFS_*.nc)
makefrc_gfs = 0        # create flux atmospheric forcing file (croco_frc_GFS_*.nc)
#
